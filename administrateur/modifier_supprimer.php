...
<head>
  ...
  <link rel="stylesheet" href="modifier_supprimer.css" />
        ...
        <div class="attendance-list">
          ...
          <table class="table">
            ...
            <?php 
                ...
                foreach($res as $row){
                  echo  "<tr><td>$row[id]</td><td>$row[titre]</td><td>$row[contenu]</td><td><img src=\"image_ajoutee/$row[images_name]\" alt=\"img\" width=\"150px\" height=\"150px\"></td><td><a class=\"lien\" href=\"modifier_section.php?id=$row[id]&titre=$row[titre]&contenu=$row[contenu]\">Modifier</a></td><td><a class=\"lien\" href=\"supprimer_section.php?id=$row[id]\">Supprimer</a></td></tr>" ;
                }
                echo "</tbody>" ;
              ?>
          </table>
