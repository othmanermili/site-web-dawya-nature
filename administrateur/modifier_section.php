  ...
  <div class="container">
    ...
    <section class="main">
        ...
        <form action="" method="POST">
          <h1 style="text-align: center;font-size: 30px;font-weight: lighter; margin: 50px; ">Modifier une section</h1>
            ...
            <?php
              ...
              if(isset($_POST["modifier"])){
                $sh = $con->prepare("UPDATE all_articles SET titre=?,contenu=? WHERE id=$id");
